...
import { deleteBulkClients } from '../../../../redux/actions/Clients';
...
const ClientTableToolbar = ({
  ...
  const handleConfirmDelete = () => {
    ...
    dispatch(deleteBulkClients(selected, () => setSelected([])));
  };
  ...
  return (
    <React.Fragment>
      ...
      <ConfirmDialog
        ...
        title={`Confirm delete clients`}
        content={'Are you sure, you want to  delete selected clients?'}
