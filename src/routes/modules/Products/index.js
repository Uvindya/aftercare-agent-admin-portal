...
import { deleteProduct, getProducts, setCurrentProduct, getDetailedCurrentProduct, setDetailedCurrentProduct } from '../../../redux/actions/Products';
...
const ProductsModule = () => {
  ...
  useEffect(() => {
    dispatch(
      getProducts(filterOptions, debouncedSearchTerm, (data) => {
                ...
                <TableRow style={{ height: 53 * 6 }}>
                  <TableCell colSpan={7} rowSpan={10}>
                    {isFilterApplied ? (
                      ...
                      <NoRecordFound>{productsFetched ? 'There are no records found.' : 'Loading products...'}</NoRecordFound>
                    )}
                  </TableCell>
                </TableRow>
              )}
