...
import { deleteBulkTechnicians } from '../../../../redux/actions/Technicians';
...
const TechnicianTableToolbar = ({
  ...
  const handleConfirmDelete = () => {
    ...
    dispatch(deleteBulkTechnicians(selected, () => setSelected([])));
  };
  ...
  return (
    <React.Fragment>
      ...
      <ConfirmDialog
        ...
        title={`Confirm delete technicians`}
        content={'Are you sure, you want to  delete selected technicians?'}
