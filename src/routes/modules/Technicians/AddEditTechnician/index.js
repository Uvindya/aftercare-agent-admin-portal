...
import { emailNotValid, requiredMessage, phoneNoNotValid, yearOfExpNotValid } from '../../../../@jumbo/constants/ErrorMessages';
...
const AddEditTechnician = ({ open, onCloseDialog, callbck}) => {
  ...
  return (
    <Dialog open={open} onClose={onCloseDialog} className={classes.dialogRoot}>
      <DialogTitle className={classes.dialogTitleRoot}>{currentTechnician ? 'Edit Technician Details' : 'Create New Technician'}</DialogTitle>
