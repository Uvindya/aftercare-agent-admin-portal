...
import { getTechnicianDashboardSummary } from '../../../../redux/actions/Reports';
...
const DashboardModule = () => {
  ...
  const [activeMaintainanceCount, setActiveMaintainanceCount] = useState(0);
  ...
  useEffect(() => {
    ...
    setActiveMaintainanceCount(dashboardSummary.activeMaintainanceCount);
