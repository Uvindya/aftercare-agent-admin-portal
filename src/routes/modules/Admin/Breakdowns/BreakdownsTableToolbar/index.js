...
import { deleteBulkBreakdowns } from '../../../../../redux/actions/Breakdowns';
...
const BreakdownTableToolbar = ({
  ...
  const handleConfirmDelete = () => {
    ...
    dispatch(deleteBulkBreakdowns(selected, () => setSelected([])));
  };
  ...
  return (
    <React.Fragment>
      ...
      <ConfirmDialog
        ...
        title={`Confirm delete breakdowns`}
        content={'Are you sure, you want to  delete selected breakdowns?'}
